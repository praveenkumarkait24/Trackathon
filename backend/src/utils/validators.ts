...
export const hackathonSchema = z.object({
  ...
  registration_deadline: z.string().datetime().or(z.string().pipe(z.coerce.date())).optional().nullable(),
  start_date: z.string().datetime().or(z.string().pipe(z.coerce.date())).optional().nullable(),
  end_date: z.string().datetime().or(z.string().pipe(z.coerce.date())).optional().nullable(),
...
export const roundSchema = z.object({
  ...
  description: z.string().optional().nullable(),
  date: z.string().datetime().or(z.string().pipe(z.coerce.date())).optional().nullable(),
